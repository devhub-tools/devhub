defmodule Devhub.Portal.Charts.BugsCreatedTest do
  use Devhub.DataCase, async: true

  alias Devhub.Portal.Charts.BugsCreated
  ...
  test "bar_chart_data/2" do
    ...
    %{datasets: datasets} = data = BugsCreated.bar_chart_data(organization_id, opts)
    ...
    assert %{
             ...
             links: [
               "/portal/metrics/bugs-created/2024-01-01",
               "/portal/metrics/bugs-created/2024-01-08",
               "/portal/metrics/bugs-created/2024-01-15",
               "/portal/metrics/bugs-created/2024-01-22",
               "/portal/metrics/bugs-created/2024-01-29",
               "/portal/metrics/bugs-created/2024-02-05",
               "/portal/metrics/bugs-created/2024-02-12",
               "/portal/metrics/bugs-created/2024-02-19",
               "/portal/metrics/bugs-created/2024-02-26"
             ]
           } == data
    ...
    assert %{
             ...
             stacked: true
           } = BugsCreated.bar_chart_config(data)
